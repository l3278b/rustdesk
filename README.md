...
- **[libs/hbb_common](https://github.com/l3278b/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs functions for file transfer, and some other utility functions
